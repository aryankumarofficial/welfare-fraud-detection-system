...
export default function QueuePage() {
  const { data: queue, error, loading } = useApi(getQueueAnalytics);
    ...
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="mb-8">
        ...
        <p className="mt-3 text-base leading-7 text-muted-foreground max-w-2xl">
          Live queue analytics from the backend reflecting pending, processing,
          and failed jobs.
        </p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <Card className="border border-border p-6">
          ...
          <CardDescription>
            Total jobs created in the prediction queue.
          </CardDescription>
      ...
      <Card className="mt-8 border border-border">
        <CardHeader className="px-6 py-5">
          ...
          <CardDescription>
            Current breakdown of queue statuses.
          </CardDescription>
        </CardHeader>
